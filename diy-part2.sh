...
## 在线用户
#git_clone_path master https://github.com/kiddin9/openwrt-packages luci-app-wrtbwmon wrtbwmon luci-app-onliner luci-theme-argon luci-app-argon-config luci-app-oaf
...
#
## 修改版本为编译日期
#grep "by alan" package/lean/default-settings/files/zzz-default-settings
#if [ $? -ne 0 ]; then
...
#else
#	date_version=$(date +"%Y.%m.%d")
#	sed -i "s/'R2.*by alan/'R${date_version} by alan/g" package/lean/default-settings/files/zzz-default-settings
#fi
#
## 修改 Makefile
